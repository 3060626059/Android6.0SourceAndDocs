...
public final class SQLiteDatabase extends SQLiteClosable {
    ...
    //每一个SQLiteDatabase对象，但是不同线程都有一份SQliteSession
    ...
    /**只是构造一个SQLiteStatement对象，sql语句可以重用
    ...
    /** SQLiteDirectCursorDriver---->SQLiteQuery---SQLiteCursor--->SQLiteSession--->SQLiteConnection
     * Runs the provided SQL and returns a cursor over the result set.
     *
     * @param cursorFactory the cursor factory to use, or null for the default factory
     * @param sql the SQL query. The SQL string must not be ; terminated
    ...
    /**  SQLiteStatement---》SQLiteSession--->SQLiteConnection
